...
# ============================================================
# *** Shared wrappers + injections (installed stock modules) ***
# ============================================================
# These blocks moved to the installed package (reorg-top-layer, 2026-07-09):
# ``lisatools.globalfit.stock.erebor.{wrappers,injections}``. Imported back
# here so this file (and the sibling settings files that import from it)
