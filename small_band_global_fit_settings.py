...
current_injections_file = "small_band_current_injections.npy"
current_snrs_file = "small_band_snr_individual_current.npy"
fp_mix = "small_band_mix_temp_file.h5"
fp_mix_final = fp_mix[:-3] + "_final.h5"
current_start_points_file = "small_band_current_start_points.npy"
current_start_points_snr_file = "small_band_current_snrs_search.npy"

fp = "testing_after_new_fuller_search_pe_threshold_100_try.h5"
folder = "./"
import os
fp_old = fp 
