...
class BruteRejection:
    ...
    def get_bf_proposal(self, coords, nwalkers, inds_reverse, inds_reverse_individual, random, args_generate=(), kwargs_generate={}, args_like=(), kwargs_like={}, args_prior=(), kwargs_prior={}, rj_info={}, betas=None):
        ...
        generated_points, log_proposal_pdf = self.special_generate_func(coords, nwalkers, *args_generate, random=random, size=self.num_brute, fill=coords[inds_reverse], fill_inds=inds_reverse_tuple, **kwargs_generate)
        ...
        if self.take_max_ll:
            ...
            if rj_info == {}:
                ...
                aux_generated_points, aux_log_proposal_pdf = self.special_generate_func(generated_points_out, nwalkers, *args_generate, random=random, size=self.num_brute, fill=generated_points_out, fill_inds=inds_tuple, **kwargs_generate)
                ...
                # scale out
                aux_log_importance_weights = np.repeat(aux_log_importance_weights[:, None], self.num_brute, axis=-1)
