...
class MPIControlGlobalFit:
    ...
    def run_global_fit(self):
        ...
        elif self.rank == self.gb_pe_rank:
            fin = run_gb_pe(self.gb_pe_gpu, self.comm, self.head_rank)

        elif self.rank == self.gb_search_rank:
