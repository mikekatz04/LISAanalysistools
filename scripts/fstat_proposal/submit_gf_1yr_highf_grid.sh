...
STORE_DIR=/shared/data/global_fit_output/gf_prod_1yr_highf_grid/
...
export GB_FSTAT_FIT_DIR=/shared/data/global_fit_output/fstat_cache_1yr_highf_grid
...
export TOBS_TARGET=31536000  # ONE YEAR (the 3mo twin uses 7776000)
