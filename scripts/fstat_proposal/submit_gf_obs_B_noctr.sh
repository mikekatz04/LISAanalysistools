...
# ===========================================================================
#SBATCH --job-name=obs_B_lowf_noctr_r2
...
#SBATCH --output=/shared/data/global_fit_output/obs_B_lowf_noctr_r2_%j.log

# ---- this arm ---------------------------------------------------------
# layers 44.5-49.5; 200 leaves because at 20 the cap would BIND
# and turn a neutrality test into a cap test
export STORE_DIR=/shared/data/global_fit_output/gf_obs_B_lowf_noctr_r2/
export BASE_FILE_NAME=gf_obs_B_lowf_noctr_r2
