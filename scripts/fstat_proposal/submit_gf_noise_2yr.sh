...
# this script runs --stock noise_mojito, which has no gb, vgb or galfor
# branch. The v8 NOISE block below it IS live -- that is the model under
# test. Read the 2-YEAR block above for what this run actually is.
# ============================================================================
...
# ---- fill these in ---------------------------------------------------------
#SBATCH --job-name=gfnoise_2yr         # job name
...
#SBATCH --output=/shared/data/global_fit_output/gfnoise_2yr_%j.log     # combined stdout+stderr (captures [MAXLOGL]/[BENCH])
# ----------------------------------------------------------------------------
...
STORE_DIR=/shared/data/global_fit_output/gf_noise_2yr/
...
SLURM_LOG=/shared/data/global_fit_output/gfnoise_2yr_${SLURM_JOB_ID:-manual}.log
LOG_MIRROR_PID=""
...
export BASE_FILE_NAME=gf_noise_2yr
