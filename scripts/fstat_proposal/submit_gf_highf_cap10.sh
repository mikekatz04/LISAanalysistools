...
# ---- fill these in ---------------------------------------------------------
#SBATCH --job-name=gf3mo_hf_c10       # job name
...
#SBATCH --output=/shared/data/global_fit_output/gf3mo_hf_c10_%j.log  # combined stdout+stderr (captures [MAXLOGL]/[BENCH])
# ----------------------------------------------------------------------------
...
STORE_DIR=/shared/data/global_fit_output/gf_prod_3mo_highf_cap10/
...
# 10 (user cap-growth test, 2026-08-24): the highf_2 run showed the cap
...
# clock to 10 to see how cap-growth speed changes the seat structure.
...
export GB_LEAF_CAP_MIN_ITERS=10
