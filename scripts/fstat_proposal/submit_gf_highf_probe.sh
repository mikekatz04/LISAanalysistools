...
#SBATCH --output=/shared/data/global_fit_output/gf3mo_highf_%j.log  # combined stdout+stderr (captures [MAXLOGL]/[BENCH])
# ----------------------------------------------------------------------------
...
STORE_DIR=/shared/data/global_fit_output/gf_prod_3mo_highf_2/
