#!/bin/bash
# ============================================================================
# STRIDE A/B -- arm 3: GB_BAND_UNIT_STRIDE=3 (widened separation)
#
# Twin of submit_stride_ab_s2.sh -- the two files are IDENTICAL except for
...
#SBATCH --job-name=strideAB3       # ---- A/B ARM ----
...
#SBATCH --output=/shared/data/global_fit_output/strideAB3_%j.log  # ---- A/B ARM ----
...
STORE_DIR=/shared/data/global_fit_output/gf_prod_3mo_stride3/   # ---- A/B ARM ----
AB_STRIDE=3                        # ---- A/B ARM ----
