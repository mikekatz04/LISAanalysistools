"""Run with: uv run python /workspace/rrondeel/pop_inf/LISAanalysistools/scripts/run_global.py -sfp /workspace/rrondeel/pop_inf/LISAanalysistools/population_inference_input/galaxy_psd_mojito_priors.py """
