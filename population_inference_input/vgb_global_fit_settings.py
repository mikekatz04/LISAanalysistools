...
from lisatools.globalfit.stock.erebor import PSDSetup, PSDSettings, MBHSetup, MBHSettings, GBSetup, GBSettings
...
def setup_recipe(
    ...
    spread_gb = np.array([1e-9, 1e-11, 1e-24, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9])
    ...
    pe_weights = [0.7, 0.2, 0.1] # [0.05, 0.45, 0.5] # 
...
def get_general_erebor_settings() -> GeneralSetup:
    ...
    file_store_dir = head_dir + "vgb_runs/"
