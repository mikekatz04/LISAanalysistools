...
print('expected f',[np.polyfit(t_phase_space, ev_theo_freq[i,:], 3)[-1] for i in range(len(ms))])
print('expected fdot',[np.polyfit(t_phase_space, ev_theo_freq[i,:], 3)[-2] for i in range(len(ms))])
print('expected fddot',[np.polyfit(t_phase_space, ev_theo_freq[i,:], 3)[-3] for i in range(len(ms))])
